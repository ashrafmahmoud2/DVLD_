...
namespace DVlD.License
{
    public partial class ucDriverLicensesHistory : UserControl
    {
        ...
        public void LoadInfo(int DriverID)
        {
            ...
            MessageBox.Show(_DriverID.ToString());
        ...
        public void LoadInfoByPersonID(int PersonID)
        {
            ...
            _Driver = clsDrivers.FindByPersoneID(PersonID);
            if (_Driver == null)
            {
                MessageBox.Show("There Is NO Driver");
                return;
           ...
           MessageBox.Show(_Driver.DriverID.ToString());

            _DriverID = _Driver.DriverID;

            if (_Driver != null)
            {
                _DriverID = clsDrivers.FindByPersoneID(PersonID).DriverID;
            }
        ...
        private void _LoadInternationalLicenseInfo()
        {
            ...
            _dtDriverInternationalLicensesHistory = clsDrivers.
                GetInternationalLicenses(_DriverID);
