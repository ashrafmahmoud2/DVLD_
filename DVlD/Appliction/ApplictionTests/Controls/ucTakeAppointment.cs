...
{
    public partial class ucTakeAppointment : UserControl
    {
        public ucTakeAppointment()
        {
            InitializeComponent();
        }
        ...
        public void LoadInfo(int LocalDrivingLicenseApplicationID, int AppointmentID = -1)
        {
            ...
            if (_CreationMode == enCreationMode.RetakeTestSchedule)
            {
                ...
                lblRetakeAppFees.Text = clsApplicationType.Find(
            ...
            lblTrial.Text =
                _LocalDrivingLicenseApplication.TotalTrialsPerTest(_TestTypeID).ToString();
        ...
        private bool _HandleActiveTestAppointmentConstraint()
        {
            ...
            {
                lblUserMessage.Text = "Person Already have an active " +
        ...
        private bool _HandleAppointmentLockedConstraint()
        {
            ...
            if(_TestAppointment==null)
            {
                MessageBox.Show("TestAppointment IS Null");
            }
            else
        ...
        private bool _HandleRetakeApplication()
        {
            ...
            if (_Mode == enMode.AddNew && _CreationMode == enCreationMode.RetakeTestSchedule)
            {
                ...
                Application.PaidFees = clsApplicationType.Find
                    ((int)clsApplication.enApplicationType.RetakeTest).ApplicationFees;
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            if (_TestAppointment.Save())
            {
                ...
                payment.Amount = decimal.Parse(lblFees.Text);
