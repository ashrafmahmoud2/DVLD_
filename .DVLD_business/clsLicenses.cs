...
namespace DVLD_business
{
    public class clsLicense
    {
        ...
        public bool _AddNewLicense()
        {
            ...
            this.LicenseID = clsLicenseDataAccessLayer.AddNewLicense(this.ApplicationID, this.DriverID, this.LicenseClass,
        ...
        private bool _UpdateLicense()
        {
            ...
            return clsLicenseDataAccessLayer.UpdateLicense(this.ApplicationID, this.LicenseID, this.DriverID, this.LicenseClass,
               this.IssueDate, this.ExpirationDate, this.Notes, this.PaidFees,
               this.IsActive, (byte)this.IssueReason, this.CreatedByUserID);
        }
        ...
        public static clsLicense Find(int LicenseID)
        {
            ...
            byte IssueReason = 1;
            if (clsLicenseDataAccessLayer.GetLicenseInfoByID(LicenseID, ref ApplicationID, ref DriverID, ref LicenseClass,
        ...
        public static int GetActiveLicenseIDByPersonID(int PersonID, int LicenseClassID)
        {
            ...
            return clsLicenseDataAccessLayer.GetActiveLicenseIDByPersonID(PersonID, LicenseClassID);

        }

        public static DataTable GetDriverLicenses(int DriverID)
        {
            return clsLicenseDataAccessLayer.GetDriverLicenses(DriverID);
        }
        ...
        {
            return (clsLicenseDataAccessLayer.DeactivateLicense(this.LicenseID));
        }
        ...
        {
            int type = (int)clsApplication.enApplicationType.RenewDrivingLicense;
            clsApplicationType type1 = clsApplicationType.Find(2);
            //First Create Applicaiton 
            clsApplication Application = new clsApplication();
            ...
            //  .enApplicationType.RenewDrivingLicense).ApplicationFees;


            Application.PaidFees = type1.ApplicationFees;
            ...
            NewLicense.PaidFees = (float)this.LicenseClassIfo.ClassFees;
        ...
        //static void TestAddLicenses()
        //{
        //    clsLicense licenses = new clsLicense();
        //    licenses.ApplicationID = 112;
        //    licenses.DriverID = 9;
        //    licenses.LicenseClass = 3;
        //    licenses.IssueDate = DateTime.Now;
        //    licenses.ExpirationDate = DateTime.Now.AddYears(1);
        //    licenses.Notes = "Test License";
        //    licenses.PaidFees = 50.0M;
        ...
        //    else
        //    {
        //        Console.WriteLine("Failed to add License.");
        //    }
        //}

        //static void TestFindLicenses()
        //{
        //    int licenseIdToFind = 27; // Replace with the actual License ID to find

        //    clsLicense foundLicense = clsLicense.Find(licenseIdToFind);

        //    if (foundLicense != null)
        //    {
        //        Console.WriteLine($"Found License: LicenseID={foundLicense.LicenseID}, Notes={foundLicense.Notes}");
        //    }
        //    else
        //    {
        ...
        //static void TestUpdateLicenses()
        //{
        //    int licenseIdToUpdate = 27; // Replace with the actual License ID to update

        //    clsLicense license = clsLicense.Find(licenseIdToUpdate);

        //    if (license != null)
        //    {
        //        Console.WriteLine($"Current Notes: {license.Notes}");

        //        // Modify the properties
        //        license.Notes = "Updated License";
        ...
        //        else
        //        {
        //            Console.WriteLine("Failed to update License.");
        //        }
        //    }
        //    else
        //    {
        ...
        //static void TestDeleteLicenses()
        //{
        //    int licenseIdToDelete = 36; // Replace with the actual License ID to delete

        //    if (clsLicense.DeleteLicenses(licenseIdToDelete))
        //    {
        //        Console.WriteLine("License deleted successfully!");
        //    }
        //    else
        //    {
        //        Console.WriteLine("Failed to delete License.");
        //    }
        //}
    }
}
